  ...
  <li><a href="#">CONTACT</a></li>
    ...
    <div class="feature1">
      <div class="textall1">
       ...
       <p class="text1">
           <br>魅力的な、大手グローバル<br>企業の求人に特化
       </p>
       <p class="text1_2">
            <br>世界を変えていく影響力を持った、
            <br>魅力的な企業の求人のみに限定。
            <br>あなたのご経験を活かせる、
            <br>意外な人気企業からのスカウトを受けることもあります
            <br>求人情報も、数多く掲載しています。
       </p>
       </div>
        <div class="pic1">
    ...
    <div class="feature3">
      <div class="textall3">
       ...
       <p class="text3">
           <br>大手グローバル企業から<br>直接の面談依頼
       </p>
       <p class="text1_3">
            <br>求人情報を掲載している魅力的な企業からの、
            <br>面談依頼（スカウト）が受けられます。
            <br>他の転職サイトや転職エージェントには依頼されない
            <br>求人情報も、数多く掲載しています。
       </p>
       </div>
        <div class="pic3">
        <img src="./img/future3.png" width="700" height="500">
        </div>
