...
//２．データ登録SQL作成
$stmt = $pdo->prepare("SELECT * FROM job_index_table WHERE corporate LIKE 'Amazon Japan'");
$status = $stmt->execute();
...
?>
    ...
    <head>
      <meta charset="UTF-8">
      <title>DIRMA-Amazon Japan</title>
    ...
    <body>
      <div style="margin:-8px;padding-top:40vh;;position:absolute;width:104%;height:400vh;font-size:10em;opacity:0.4;background-color:#888888;text-align:center;z-index:999;">(demo)</div>
        <div id="top">
          ...
          <h2 id="corpname">Amazon Japan　エンタープライズ営業(大手銀行・証券), AWS</h2>
