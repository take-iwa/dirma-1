...
//２．データ登録SQL作成
$stmt = $pdo->prepare("SELECT * FROM job_index_table WHERE corporate LIKE '住友商事株式会社'");
$status = $stmt->execute();
    ...
    <body>
      <div style="margin:-8px;padding-top:40vh;;position:absolute;width:104%;height:400vh;font-size:10em;opacity:0.4;background-color:#888888;text-align:center;z-index:999;">(demo)</div>
        <div id="top">
          ...
          <h2 id="corpname">住友商事株式会社　デジタルメディア事業における広告営業・クリエイティブ関連業務推進</h2>
