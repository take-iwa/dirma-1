...
?>
  <div class="container main-area">
    <ul class="nav nav-tabs" role="tablist">
      ...
      <li role="presentation" class="<?=$_GET['page'] == 'company_messages' ? 'active' : ''?>"><a href="company_page.php?page=company_messages&box=inbox"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> メッセージ</a></li>
    </ul>